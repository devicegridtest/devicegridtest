document.addEventListener('DOMContentLoaded', () => {
    ...
    // ====== SONIDOS ======
const successSound = new Audio('https://devicegridtest.org/nexa_faucet_backend/frontend/faucet/success.mp3');
const errorSound = new Audio('https://devicegridtest.org/nexa_faucet_backend/frontend/faucet/error.mp3');
